...
/**
 * Performs basic action on instances of {@link Flushable}.
 * 
 * @author Michele Sama
 *
 */
public class Flushables {
   ...
   *
   * <p>If {@code quietly} is true, then we don't rethrow
   ...
   */
  public static void flush(Flushable flushable, boolean quietly)
      throws IOException {
    try {
      flushable.flush();
    } catch (IOException e) {
