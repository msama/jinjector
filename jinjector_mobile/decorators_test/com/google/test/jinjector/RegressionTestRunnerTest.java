...
public class RegressionTestRunnerTest extends TestCase {
  ...
  public void testDoRun_allTestRunned() {
    ...
    try {
      ...
      fail("The runner has been interrupted before termination: " + 
          e.getMessage());
    }
  ...
  public void testDisplayResult_isInvoked() {
    ...
    assertTrue("displayResult() has not been invoked.", 
        strategy.hasDisplayedResults);
  }
   ...
   */
  public static void runAndWaitUntilTermination(AssistedTestCase test) 
   ...
   * @throws InterruptedException if the test is interrupted while waiting.
   */
  public static void runAndWaitUntilTermination(RegressionTestRunner runner) 
      throws InterruptedException {
    runner.start();
    // Waits for the runner to terminate.
    do {
        Thread.sleep(200);
